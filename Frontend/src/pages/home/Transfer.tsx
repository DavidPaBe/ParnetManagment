...
function TransferButton() {
  ...
  const { api } = useApi();
   ...
   // Add your programID
   const programIDFT =
   "0x5f8cab6761e4255c1da4b021725a9770fd43cdfdd4980c94202119dd6f9c21c5";
 ...
 const meta =
  ...
  const message: any = {
    ...
    payload: {
      transfer: [
        decodeAddress("from: 0x207fa7f47bb01f72d89d5bb826a271f6d46da927124b6ef1361a05ff885c6f41"),
        decodeAddress("to: 0x207fa7f47bb01f72d89d5bb826a271f6d46da927124b6ef1361a05ff885c6f41"),
        750,
      ],
    },
    gasLimit: 899819245,
  ...
  return <Button onClick={signer}>Send Message and sing</Button>;
}
